...
from app.schemas.story import CharacterDesignerOutput, NovelSeed, WorldbuilderOutput
...
def run(
    ...
    hint = json.dumps(WorldbuilderOutput.model_json_schema(), ensure_ascii=False)[:12000]
