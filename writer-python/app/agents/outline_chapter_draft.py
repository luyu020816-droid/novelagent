...
from app.schemas.chapter import ChapterContract, InitialCriticOutput
...
def run(
    ...
    gr = gateway.chat_completion(
        ...
        temperature=0.3,
        agent_name="outline_chapter_draft",
        node_name="main",
